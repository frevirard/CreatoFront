...
import { AppAddClientComponent } from './add/add.component';
...
export class AppClientComponent implements AfterViewInit {
  ...
  addRowData(row_obj: Client): void {
    ...
    this.dialog.open(AppAddClientComponent);
    this.table.renderRows();
  }

  // tslint:disable-next-line - Disables all
  updateRowData(row_obj: Client): boolean | any {
  ...
  // tslint:disable-next-line - Disables all
  deleteRowData(row_obj: Client): boolean | any {
    this.dataSource.data = this.dataSource.data.filter((value: any) => {
